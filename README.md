...
…or create a `.env` file in the project (auto-loaded by every entry point — the
MCP server, the CLI and the Console backend all resolve settings the same way):
